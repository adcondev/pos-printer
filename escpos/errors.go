...
var (
	...
	ErrEmptyBuffer = errors.New("trying to print an empty buffer")
	// ErrBufferOverflow buffer is too large
	ErrBufferOverflow = errors.New("trying to print overflowed buffer (protocol max 64KB; model may be lower)")
